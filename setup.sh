...
ss -lntp | grep -qE ':80 ' && WS_STATUS="\033[1;32mONLINE\033[0m" || WS_STATUS="\033[1;31mOFFLINE\033[0m"
...
ps -ef | grep "sshd:" | grep -v "priv" | grep -v grep | awk -F'sshd: ' '{print $2}' | awk '{print $1}' | sort | uniq -c
